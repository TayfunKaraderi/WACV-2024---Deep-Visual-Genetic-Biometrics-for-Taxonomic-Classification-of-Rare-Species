...
class resnet50_embeddings(nn.Module):
    def __init__(self, block, layers, num_classes=25, groups=32, width_per_group=4, embedding_size=1000): ##
        ...
        self.fc_softmax = nn.Linear(1000, num_classes) #was  1024 * block.expansion, 1000
        self.fc_embedding = nn.Linear(1000, embedding_size) # 1024 * block.expansion, embedding_size=1000
    ...
    def forward(self, x):
        ...
        return x_embedding #x_softmax, x_embedding
