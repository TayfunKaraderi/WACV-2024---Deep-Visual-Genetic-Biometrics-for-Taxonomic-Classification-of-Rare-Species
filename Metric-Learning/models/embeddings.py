...
def resnet50(pretrained=False,  num_classes=32, ckpt_path=False, embedding_size = 128, **kwargs):
    # Define the model
...
def DNA_FCL_():
    model = DNA_FCL()
    #transfer learning
    PATH =  "/content/drive/MyDrive/foram-MetricLearningIdentification-master/output/fold_0/current_fcl_model_state.pkl"
