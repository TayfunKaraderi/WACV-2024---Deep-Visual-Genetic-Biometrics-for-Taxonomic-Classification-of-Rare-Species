...
def inferEmbeddings(args, dataset, split):
	...
	#model = resnet50(pretrained=True, num_classes=dataset.getNumClasses(), ckpt_path='output/fold_0/current_model_state.pkl', embedding_size=args.embedding_size)
	model = resnet50(pretrained=True, num_classes=dataset.getNumClasses(), ckpt_path='output/fold_0/current_model_state.pkl', embedding_size=128)
