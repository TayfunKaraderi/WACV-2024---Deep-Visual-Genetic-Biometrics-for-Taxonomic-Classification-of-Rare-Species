...
#transfer learning        
'''
def TripletResnet50Softmax(pretrained=False,  num_classes=25, embedding_size=128, **kwargs):
    ...
    if pretrained:
        ...
        model = Triplet_ResNet_Softmax(Bottleneck, [3, 4, 6, 3], num_classes=25, **kwargs)
        model.fc = nn.Linear(2048, 1000)
        model.fc_embedding = nn.Linear(1000, embedding_size)
        model.fc_softmax = nn.Linear(1000, num_classes)
        PATH =  "/content/drive/MyDrive/foram-MetricLearningIdentification-master/output/fold_0_025to073confidence_31epoch_076acc/best_model_state.pkl"
